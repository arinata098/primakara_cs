...
{
    public function laporanKebun(Request $request)
    {
        ...
        return view('admin.laporan.kebun', [
            'title' => 'Kebun',
            'section' => 'Laporan',
            'active' => 'Kebun',
            'export' => $groupedData,
    ...
    public function prepareDataForExportKebun(Request $request)
    {
        // Mengambil tanggal awal dan tanggal akhir dari request jika tersedia
        $tanggalAwal = $request->filled('tanggal_awal') ? $request->input('tanggal_awal') : null;
        $tanggalAkhir = $request->filled('tanggal_akhir') ? $request->input('tanggal_akhir') : null;
    ...
    public function exportToExcelKebun(Request $request)
    {
        ...
        $exportData = $this->prepareDataForExportKebun($request, $tanggalAwal, $tanggalAkhir);
