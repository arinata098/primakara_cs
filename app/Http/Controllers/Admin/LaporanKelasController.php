...
class LaporanKelasController extends Controller
{
    public function laporanKelas(Request $request)
    {
        ...
        return view('admin.laporan.kelas', [
            'title' => 'Kelas',
            'section' => 'Laporan',
            'active' => 'Kelas',
            'export' => $groupedData,
    ...
    public function prepareDataForExportKelas(Request $request)
    {
        // Mengambil tanggal awal dan tanggal akhir dari request jika tersedia
        $tanggalAwal = $request->filled('tanggal_awal') ? $request->input('tanggal_awal') : null;
        $tanggalAkhir = $request->filled('tanggal_akhir') ? $request->input('tanggal_akhir') : null;
    ...
    public function exportToExcelKelas(Request $request)
    {
        ...
        $exportData = $this->prepareDataForExportKelas($request, $tanggalAwal, $tanggalAkhir);
