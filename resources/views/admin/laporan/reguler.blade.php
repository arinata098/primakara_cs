                                    ...
                                    <div class="card-body pb-5">
                                        ...
                                        <div class="card-px pt-10 d-flex justify-content-between">
                                            ...
                                            <div class="d-inline">
                                                ...
                                                <a href="{{ route('exportToExcelReg') }}?tanggal_awal={{ request()->input('tanggal_awal') }}&tanggal_akhir={{ request()->input('tanggal_akhir') }}" class="btn btn-success fs-6">Export to Excel</a>
                                            </div>
                                            <!--end::Title-->
                                            <!--begin::Filter Form-->
                                            <form method="get" action="{{ route('laporanReg') }}" class="d-flex align-items-center">
                                                <div class="me-2">
