			...
			<div id="kt_content_container" class="container-xxl">
				...
				<div class="card">
					...
					<div class="card-body pb-5">
						...
						<!--begin::Table-->
                        <div class="mt-15">
                            <form action="{{ route('update.checklist', $checkList->id_list ) }}" method="POST">
                                @csrf
                                <div class="mb-10">
                                    <label for="exampleFormControlInput1" class="required form-label">Nama List Pekerjaan</label>
                                    <input type="text" value="{{$checkList->nama_list}}" class="form-control form-control-solid" required name="nama_list"/>
                                </div>
