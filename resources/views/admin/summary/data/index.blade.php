									...
									<div class="card-body pb-0">
										...
										<div class="row g-5 g-xl-8">
											<div class="col-xl-4">
												...
												<a href="{{ route('lantaiRuangan', 1) }}" class="card bg-info hoverable card-xl-stretch mb-xl-8">
													<!--begin::Body-->
													<div class="card-body">
														...
														<!--end::Svg Icon-->
														<div class="text-white fw-bolder fs-2 mb-2 mt-5">Lantai 1</div>
													</div>
													<!--end::Body-->
												</a>
											...
											<div class="col-xl-4">
												<!--begin::Statistics Widget 5-->
												<a href="{{ route('lantaiRuangan', 2) }}" class="card bg-success hoverable card-xl-stretch mb-xl-8">
													<!--begin::Body-->
													<div class="card-body">
														...
														<!--end::Svg Icon-->
														<div class="text-white fw-bolder fs-2 mb-2 mt-5">Lantai 2</div>
													</div>
													<!--end::Body-->
												</a>
												<!--end::Statistics Widget 5-->
											...
											<div class="col-xl-4">
												<!--begin::Statistics Widget 5-->
												<a href="{{ route('lantaiRuangan', 3) }}" class="card bg-warning hoverable card-xl-stretch mb-5 mb-xl-8">
													<!--begin::Body-->
													<div class="card-body">
														...
														<!--end::Svg Icon-->
														<div class="text-white fw-bolder fs-2 mb-2 mt-5">Lantai 3</div>
													</div>
													<!--end::Body-->
												</a>
												<!--end::Statistics Widget 5-->
                                            ...
                                            <div class="col-xl-4">
												<!--begin::Statistics Widget 5-->
												<a href="{{ route('lantaiRuangan', 4) }}" class="card bg-primary hoverable card-xl-stretch mb-5 mb-xl-8">
													<!--begin::Body-->
													<div class="card-body">
														<!--begin::Svg Icon | path: icons/duotune/graphs/gra005.svg-->
														<span class="svg-icon svg-icon-white svg-icon-3x ms-n1">
														...
														<!--end::Svg Icon-->
														<div class="text-white fw-bolder fs-2 mb-2 mt-5">Lantai 4</div>
													</div>
													<!--end::Body-->
												</a>
												<!--end::Statistics Widget 5-->
